...
namespace MutuaideWCF.DAL
{
    ...
    public partial class Contact
    {
        ...
        /// Tri par statecode afin d'avoir les actifs avant les innactifs en cas de doublons
        /// </summary>
        ...
        internal static Entity GetContactById(string pcidssId, XrmServices crmServices)
        {
            return (crmServices.GetServiceContext().CreateQuery("contact")
                ...
                .OrderBy(e => e.GetAttributeValue<OptionSetValue>("statecode"))
                .FirstOrDefault() ?? new Entity());

        }

        /// <summary>
        /// Retourne le contact correspondant aux paramètres passés
        /// Tri par statecode afin d'avoir les actifs avant les innactifs en cas de doublons
        /// </summary>
        /// <param name="lastName"></param>
        /// <param name="firstName"></param>
        /// <param name="birthDate"></param>
        /// <param name="codeCdo"></param>
        ...
        /// <summary>
        /// Retourne le premier contact trouvé ayant ce PCIDSS. Tri par statecode afin d'avoir les actifs avant les inactifs en cas de doublon
        /// </summary>
        /// <param name="id"></param>
